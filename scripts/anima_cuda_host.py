...
def install_kernel_policy(sm_count):
    ...
    if os.environ.get("LUMEN_KERNEL_POLICY") != key:
        ...
        # Reuse verified policy binaries after relocating the environment. Their
        # recorded RUNPATH may point at the former installation; resolve CUDA
        # from this pinned environment without rebuilding or changing binaries.
        library_paths = [str(cublas / "lib"), str(runtime / "lib")]
